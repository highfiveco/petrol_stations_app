...
public class PosItemsRepository {
    ...
    private final ItemsCacheDao cacheDao;
    private final Gson gson;

    public PosItemsRepository(PosItemDao itemDao, ItemsCacheDao cacheDao, Gson gson) {
...
//         ItemsCacheEntity c = new ItemsCacheEntity();
//        c.id = 1;
