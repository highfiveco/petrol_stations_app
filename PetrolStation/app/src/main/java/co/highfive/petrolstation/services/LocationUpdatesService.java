...
import co.highfive.petrolstation.helper.Utils;

public class LocationUpdatesService extends Service {
    private static final String PACKAGE_NAME =
            "com.abueskandar.vehicletracking";
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = getString(R.string.app_name_ar);
...
//            removeLocatNotificationChannelionUpdates();
                stopSelf();
            }
