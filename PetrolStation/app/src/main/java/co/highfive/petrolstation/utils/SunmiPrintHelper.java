...
public class SunmiPrintHelper {
     ...
     */
    public void printBitmap(Bitmap bitmap,String text) {
        if(sunmiPrinterService == null){
            Log.e("sunmiPrinterService","null");
            //TODO Service disconnection processing
            return;
        }
        ...
        try {
                ...
                sunmiPrinterService.printBitmap(bitmap, new InnerResultCallback() {
                    ...
                    public void onRunResult(boolean isSuccess) throws RemoteException {
                        Log.e("onRunResult",""+isSuccess);
                    }

                    @Override
                    public void onReturnString(String result) throws RemoteException {
                        Log.e("onReturnString",""+result);

                    }

                    @Override
                    public void onRaiseException(int code, String msg) throws RemoteException {
                        Log.e("onRaiseException",""+msg);
                    }
